...
const views = {
  ...
  ["home/index.html"]: async () => (await import('./index5-712213a4.js')).default,
  ["home/components/popular-tags.html"]: async () => (await import('./popular-tags-0aa26546.js')).default,
...
const attributeRules = {
  ...
  element(next2, data2, options2) {
    ...
    const regex2 = new RegExp(`(?:^|\\s)${escapeRegex(value)}(?:$|\\s)`, shouldIgnoreCase(data2, options2) ? "i" : "");
...
//# sourceMappingURL=index-e0c4b9cb.js.map
