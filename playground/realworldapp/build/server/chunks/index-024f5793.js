...
const views = {
  ...
  ["profile/index.html"]: async () => (await import('./index3-61fd09ac.js')).default,
  ["markdown/index.md.html"]: async () => (await import('./index.md-6bd03659.js')).default,
  ["login/index.html"]: async () => (await import('./index4-c5c699cf.js')).default,
  ["home/index.html"]: async () => (await import('./index5-0e27ca84.js')).default,
  ["home/components/popular-tags.html"]: async () => (await import('./popular-tags-6e00615a.js')).default,
  ...
  ["components/favorite-button.html"]: async () => (await import('./favorite-button-3312d0be.js')).default,
  ["components/auth-errors.html"]: async () => (await import('./auth-errors-e6645788.js')).default,
  ["components/article-preview.html"]: async () => (await import('./article-preview-374f148f.js')).default,
...
async function render(view, props = {}) {
  ...
  }).pipe(Effect.catchTag("NoSuchElementException", (e) => {
    var _a3;
    let html3 = error({
      status: 404,
      message: (_a3 = e.message) !== null && _a3 !== void 0 ? _a3 : `View "${view}" not found in views directory`
    });
...
app.get("/", async (ctx) => {
  ...
  console.log("data", data2.articles);
...
//# sourceMappingURL=index-024f5793.js.map
